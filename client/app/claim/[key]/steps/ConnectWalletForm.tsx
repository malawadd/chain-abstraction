...
export default function ConnectWalletForm() {
    ...
    return  <div className="flex flex-col w-full gap-2">
        ...
        <p className='text-sm text-center text-gray-500 px-4 pb-2'>Connect with your wallet to proceed.  No ETH needed to claim, the Gifts pays for itself for uncapsuling.</p>
