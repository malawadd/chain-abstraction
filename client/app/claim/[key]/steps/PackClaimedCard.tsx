...
export function PackClaimedCard() {
    ...
    return <Card
        ...
        <div className="flex flex-col items-center gap-8">
            ...
            <h1 className="text-xl">You have been Encapsulated!</h1>
            <p className='my-4 text-gray-400 text-sm'>The contents of the Gifts are now in your wallet.</p>
            <p className='my-4 text-sm'>Share this Gifts with someone on socials:</p>
