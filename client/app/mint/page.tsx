...
const MintPage = () => {
    ...
    if (!isConnecting && !isConnected) {
        return <Card
            ...
            <div className="flex flex-col items-center pb-4">
                ...
                <h1 className="text-lg sm:text-xl md:text-2xl mb-10">Create new Gifts</h1>
                <ConnectButton/>
            </div>
        </Card>
    }
    ...
    if (isLoading && hash) return (
        <LoadingCard
            title="Your Gifts is being created..."
    ...
    return (
        <Card
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <h1 className="text-lg sm:text-xl md:text-2xl">Create new Gifts</h1>
