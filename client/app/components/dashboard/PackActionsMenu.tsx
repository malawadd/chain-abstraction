        ...
        <Menu >
            ...
            >
                <Menu.Items
                    ...
                    <Menu.Item>
                        {({active}) => (
                            <HelpItem title={'Revoke Gifts'}>
                                <p>If a Gifts hasn&apos;t been claimed, you can revoke it to retrieve your assets. This is
                                    often preferable to self-claiming the Gifts.</p>
                                <div className='flex justify-end'>
                                    <Button
                                        onClick={() => setIsRevokeOpen(true)}
                                        leftIcon={<BsX className="text-xl"/>}>Revoke Gifts </Button>
                                </div>
                            </HelpItem>
                        )}
                    </Menu.Item>
