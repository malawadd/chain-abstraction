    ...
    const card = useCallback((closeModal: () => void) => {
            ...
            return <Card
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className='text-center pb-8'>
                        <h2 className="text-2xl font-bold ">Revoke Gifts</h2>
                    </div>
                    {packData && <ReviewData
                        eth={rawEth ?? BigInt(1)}
        ...
        return <Card
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                <h1 className="text-xl">Gifts Revoked!</h1>

                <p className="text-sm mt-10">The contents of the Gifts are back in your wallet!</p>
            </div>
        </Card>
